...
class SearchBar extends React.Component {
    constructor() {
        ...
        this.renderTextInput = () => {
            ...
            return (<react_native_masked_text_1.TextInputMask placeholderTextColor={darkMode ? "#fdfdfd" : "#19191a"} {...this.props} type={type} options={options} onBlur={onBlur} onFocus={onFocus} ref={(ref) => (this.inputRef = ref)} style={[SearchBar_style_1._textInputStyle(darkMode), textInputStyle]} placeholder={placeholder}/>);
        };
